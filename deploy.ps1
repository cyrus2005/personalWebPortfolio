# Cyrus Wilburn Portfolio - PowerShell Deployment Script
...
if ($remotes -and $remotes -match "origin") {
    Write-Host "GitHub remote detected. Would you like to push to GitHub? (y/n)" -ForegroundColor Cyan
    ...
    Write-Host "No GitHub remote found. To set up GitHub deployment:" -ForegroundColor Yellow
    Write-Host "1. Create a repository on GitHub" -ForegroundColor White
    Write-Host "2. Run: git remote add origin https://github.com/yourusername/repo.git" -ForegroundColor White
